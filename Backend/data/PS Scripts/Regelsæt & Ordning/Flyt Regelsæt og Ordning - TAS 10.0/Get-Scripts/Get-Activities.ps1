...
if($regelsæt_id -ne $false){
    ...
    try{
        ...
        $query = "select distinct a1.AKTIVITET_KODE,a1.TEKST, a1.KONS_ECO,a1.KONS_BREV,a1.KONS_SAGSLOG,a1.AUTO_REMINDER,a1.AUTO_GODKEND,a1.EGEN_GODKENDELSE,a1.OBJEKT,a1.AKTIV,a1.AKTIVITET_TYPE,a1.BUDGET,a1.NY_SAGSBEHANDLER,a1.PublicAvailableForApplicationService,a1.PublicName
                    ...
                    ,aq.HeaderSubText,aq.BottomHtmlText, rsk.SCR_KONTO, rsk.DEB_KRE_FINANS, rsk.PROCENT AS 'RSK_PROCENT', rsk.DEB_KRE AS 'RSK_DEB_KRE', rsk.MODKONTO, rsk.YEAR, rsk.RG_KONTERING_GRUPPE, rsk.RAMME, rsk.UDLIGNING, rsk.TRANSAKTIONSTYPE,rsk.FOND
                                        from AKTIVITET a1
                                        ...
                                        on aq.Id = a1.ActivityQuotaId
										left join RG_SCR_KONTOPLAN rsk
										on rtk.TAS_KONTO = rsk.TAS_KONTO
