...
if($regelsæt_id -ne $false){
    ...
    try{
        ...
        if($connection.State -eq "Open"){
            ...
            $query = "select AKTIVITET.AKTIVITET_KODE, AKTIVITET_SECURITY.NAME,AKTIVITET_SECURITY.STATUS,AKTIVITET_SECURITY.synlig,AKTIVITET_SECURITY.HideFormActivity
            ...
            $result | Export-Csv -Path $path/ActivitiesSecurityPermissions.csv -NoTypeInformation -Encoding UTF8
