    ...
    function UpdateQuery([Object] $activity){
        ...
        if($ActivityQuota -ne 'NULL'){            
            ...
            if([string]::IsNullOrEmpty($activityQuotaId)){
                ...
                $activity_quota_query = "INSERT INTO ActivityQuota(Id, ActivityId, ActivityQuotaType, HeaderTitle, HeaderSubText, BottomHtmlText) `r`n VALUES('$newActivityQuotaId', $activity_id, $quotaType, '$title', '$subText', '$htmlText') `r`n"
