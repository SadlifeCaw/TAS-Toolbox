...
function Replace-EscapeCharacters{
    Param(
...
function DoesSecurityUsernameExist{
...
function DoesSchemaSecurityExist{
    ...
    $query = "select APPLICATION
            from SECURITY_INFO
            where WINDOW = 'SagMain' AND CONTROL = '$Control' AND USER_NAME = '$Username'"
