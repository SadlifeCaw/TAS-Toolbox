...
function DoesSchemaSettingExist{
    ...
    $FORSYSTEM_ID = GetSchemaID -schema_name $FORSYSTEM_NAME
    $OPEN_ACTIVITY = GetActivityId -Activity_code $OPEN_ACTIVITY_CODE
    ...
    if($CLOSE_ACTIVITY_CODE -eq 'NULL'){
        ...
        $CLOSE_ACTIVITY = GetActivityId -Activity_code $CLOSE_ACTIVITY_CODE
...
function DoesWordSettingExist{
    ...
    $activity_id = GetActivityId -Activity_code $Code
