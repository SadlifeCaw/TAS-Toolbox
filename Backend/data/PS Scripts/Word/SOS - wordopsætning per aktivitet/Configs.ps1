...
$Status_initials = 'EXMPL001' #Initials for the status' you want to transfer. Try to make sure the initial doesnt overlab with others. Fx. 'BY' and 'BYP'. The SQL query will get both. 
