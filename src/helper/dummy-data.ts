...
interface DummyDataObj {
    ...
    BILLS : Bill[];
    DOWNLOADS_HISTORY: DownloadHistoryRecord[];
}
...
const DummyData: DummyDataObj = Object.freeze({
    ...
    DOWNLOADS_HISTORY: [
        { downloadDate: moment().subtract(1, "days").format("DD MMM YYYY, HH:mm"), user: "Benny", customer: "KundeA", script: "Dokument", status: "Success" },
        { downloadDate: moment().subtract(2, "days").format("DD MMM YYYY, HH:mm"), user: "Casper", customer: "KundeB", script: "Skema", status: "Failed" },
        { downloadDate: moment().subtract(5, "days").format("DD MMM YYYY, HH:mm"), user: "Benny", customer: "KundeC", script: "Flow", status: "Success" },
        { downloadDate: moment().subtract(10, "days").format("DD MMM YYYY, HH:mm"), user: "Benny", customer: "KundeA", script: "Visningsgruppe", status: "Success" },
    ]
